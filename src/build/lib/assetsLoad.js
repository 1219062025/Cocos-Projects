...
cc.loader.addDownloadHandlers({
  ...
  mp4: function (item, callback) {
    var data = "data:video/mp4;base64," + window.res[item.url];
    callback(null, data);
  },
