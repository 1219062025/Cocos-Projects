...
export const initBuildStartEvent = (
...
export const initBuildFinishedEvent = async (
  options: TBuildOptions,
  callback?: () => void
) => {
...
export const builder2x = () => {
  // 初始化 start
  const { buildPlatform, originPkgPath } = getAdapterConfig();
  // 初始化 end
