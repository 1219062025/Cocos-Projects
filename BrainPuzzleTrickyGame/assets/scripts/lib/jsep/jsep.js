...
class Jsep {
  ...
  gobbleNumericLiteral() {
    ...
    if (Jsep.isIdentifierStart(chCode)) {
      ...
      (number.length === 1 && number.charCodeAt(0) === Jsep.PERIOD_CODE)
    ) {
...
// console.log(require("./command.js"));
